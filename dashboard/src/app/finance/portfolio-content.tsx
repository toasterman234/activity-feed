    ...
    <div className="space-y-3">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <input type="text" value={search} onChange={e => setSearch(e.target.value)} placeholder="Filter…" className="rounded-md border border-zinc-200 bg-card px-2 py-0.5 text-xs text-zinc-800 placeholder:text-zinc-400 w-28 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-200" />
          <select value={sort} onChange={e => setSort(e.target.value as any)} className="rounded-md border border-zinc-200 bg-card px-2 py-1 text-[10px] text-zinc-600 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-400">
      ...
      <div className="space-y-2">
        {accounts.map(a => {
          ...
          return (
            <div key={a.key} className={`rounded-lg border border-zinc-200 bg-card dark:border-zinc-800 dark:bg-zinc-900 ${expanded ? "ring-1 ring-zinc-300 dark:ring-zinc-700" : ""}`}>
