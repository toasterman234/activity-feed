...
export function ExecutionHandoffWorkspace({
  ...
  const activeExecution = useMemo(() => {
    ...
    if (["accepted", "rejected", "stopped", "closed", "wont_fix"].includes(first.state)) return null;
    return first;
  }, [executions]);
      ...
      <section className="rounded-xl border border-emerald-300 bg-white p-3 shadow-[0_10px_30px_rgba(24,24,27,0.05)] dark:border-emerald-800 dark:bg-zinc-900">
        ...
        {activeExecution && (
          <details className="mt-3 border-t border-zinc-200 pt-3 dark:border-zinc-800">
            ...
            <div className="mt-2">
              <button
                disabled={!repoId || busy !== null || !selected?.exists_on_disk}
              ...
              >
                {busy === "start" ? "Creating…" : "Create another"}
              </button>
            </div>
          </details>
        )}
    ...
    <section className="rounded-xl border border-emerald-300 bg-white p-3 shadow-[0_10px_30px_rgba(24,24,27,0.05)] dark:border-emerald-800 dark:bg-zinc-900">
      ...
      {executions.length > 0 && (
        <div className="mt-3 border-t border-zinc-200 pt-3 dark:border-zinc-800">
          <p className="font-mono text-[9px] uppercase tracking-wide text-zinc-400">Previous executions</p>
