  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center bg-black/40 p-3 sm:items-center">
      <div
        ...
        className="w-full max-w-md rounded-xl border border-zinc-200 bg-card p-4 shadow-lg dark:border-zinc-700 dark:bg-zinc-900"
      >
        ...
        {destinations.length === 0 ? (
          ...
          <label className="mt-3 block">
            ...
            <select
              ...
              className="mt-1 w-full rounded-md border border-zinc-200 bg-card px-2 py-2 text-sm dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-200"
            >
              {destinations.map((c) => (
