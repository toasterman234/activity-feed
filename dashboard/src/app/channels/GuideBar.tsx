        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          {isAcceptedPlan && onScrollToExecution && (
            <button
              ...
              className="rounded-md border border-emerald-300 bg-card px-2.5 py-1 text-[11px] font-medium text-emerald-700 hover:bg-emerald-100 dark:border-emerald-700 dark:bg-emerald-900 dark:text-emerald-300 dark:hover:bg-emerald-800"
            >
              Execute plan ↓
            </button>
          )}
