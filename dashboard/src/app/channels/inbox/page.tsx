    ...
    <div className="min-h-screen bg-zinc-50 pb-16 dark:bg-zinc-950">
      <header className="sticky top-0 z-10 border-b border-zinc-200 bg-white/95 backdrop-blur dark:border-zinc-800 dark:bg-zinc-950/95 pt-[env(safe-area-inset-top,0px)]">
        <div className="mx-auto flex max-w-5xl items-center justify-between px-3 py-2">
          <div>
            <h1 className="text-sm font-semibold text-zinc-800 dark:text-zinc-200">Graph Inbox</h1>
            <p className="text-[11px] text-zinc-500 dark:text-zinc-400">Review pending decisions, proposals, and memory candidates.</p>
          </div>
          <Link href="/channels" className="text-xs text-blue-600 dark:text-blue-400">Back to channels</Link>
        </div>
      </header>
